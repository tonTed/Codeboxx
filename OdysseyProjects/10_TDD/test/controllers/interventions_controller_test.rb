...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { author: @intervention.author, battery_id: @intervention.battery_id, building_id: @intervention.building_id, column_id: @intervention.column_id, customer_id: @intervention.customer_id, elevator_id: @intervention.elevator_id, end_date_intervention: @intervention.end_date_intervention, report: @intervention.report, result: @intervention.result, start_date_intervention: @intervention.start_date_intervention, status: @intervention.status } }
    end
